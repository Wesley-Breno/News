...
def noticia(site):
    ...
    if site == 0:
        ...
        for image in images:
            imagens.append(re.findall(r'src=\"(https://img.olhardigital.com.br/wp-content/uploads/\d*/\d*/-*[a-z\d]*_*-*[a-z\d]*_*-*[a-z\d]*_*-*[a-z\d]*_*-*[a-z\d]*_*-*[a-z\d]*_*-*[a-z\d]*_*-*[a-z\d]*_*-*[a-z\d]*_*-*[a-z\d]*_*-*[a-z\d]*_*-*[a-z\d]*_*\.\w*)\"', str(image), re.I))
